...
@NgModule({
  declarations: [FrooComponent, SidebarComponent, HomeComponent, EventComponent, EventConfirmComponent, PageTitleComponent, ThanksComponent, IncidentComponent, TimeOfIncidentComponent, RaceDetailsComponent, LocationDetails1Component, LocationDetails2Component, LocationDetails3Component],
  imports: [
    CommonModule,
    NgbModule,
    FormsModule,
